...
#ifndef ConstraintScopeLexerBASE_H_INCLUDED
#define ConstraintScopeLexerBASE_H_INCLUDED
...
class ConstraintScopeLexerBase
{
...
public:
    ConstraintScopeLexerBase(ConstraintScopeLexerBase const &other)             = delete;
    ConstraintScopeLexerBase &operator=(ConstraintScopeLexerBase const &rhs)    = delete;
...
protected:
    ConstraintScopeLexerBase(std::istream &in, std::ostream &out);
    ConstraintScopeLexerBase(std::string const &infilename, std::string const &outfilename);
...
inline std::ostream &ConstraintScopeLexerBase::out()
{
    return *d_out;
}

inline void ConstraintScopeLexerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void ConstraintScopeLexerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline bool ConstraintScopeLexerBase::atFinalState()
{
    return d_final.notAtBOL.rule != std::numeric_limits<size_t>::max() || 
            (d_atBOL && d_final.atBOL.rule != std::numeric_limits<size_t>::max());
}

inline void ConstraintScopeLexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void ConstraintScopeLexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &ConstraintScopeLexerBase::matched() const
{
    return d_matched;
}

inline ConstraintScopeLexerBase::StartCondition__ ConstraintScopeLexerBase::startCondition() const
{
    return d_startCondition;
}

inline std::string const &ConstraintScopeLexerBase::filename() const
{
    return d_filename;
}

inline void ConstraintScopeLexerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t ConstraintScopeLexerBase::length() const
{
    return d_matched.size();
}

inline void ConstraintScopeLexerBase::leave(int retValue) const
{
    throw static_cast<Leave__>(retValue);
}

inline size_t ConstraintScopeLexerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void ConstraintScopeLexerBase::more()
{
    d_more = true;
}

inline void ConstraintScopeLexerBase::begin(StartCondition__ startCondition)
{
    d_dfaBase__ = 
        s_dfaBase__[static_cast<int>(d_startCondition = startCondition)];
}

inline size_t ConstraintScopeLexerBase::state__() const
{
    return d_state;
}

inline size_t ConstraintScopeLexerBase::get__()
{
    return d_input.get();
}

inline bool ConstraintScopeLexerBase::return__()
{
    return d_return;
}

inline void ConstraintScopeLexerBase::noReturn__()
{
    d_return = false;
}


#endif //  ConstraintScopeLexerBASE_H_INCLUDED
