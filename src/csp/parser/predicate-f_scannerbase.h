...
#ifndef PredicateFunctionalLexerBASE_H_INCLUDED
#define PredicateFunctionalLexerBASE_H_INCLUDED
...
class PredicateFunctionalLexerBase
{
...
protected:
    ...
    int     const (*d_dfaBase__)[43];

    static int     const s_dfa__[][43];
    static int     const (*s_dfaBase__[])[43];
...
public:
    PredicateFunctionalLexerBase(PredicateFunctionalLexerBase const &other)             = delete;
    PredicateFunctionalLexerBase &operator=(PredicateFunctionalLexerBase const &rhs)    = delete;
...
protected:
    PredicateFunctionalLexerBase(std::istream &in, std::ostream &out);
    PredicateFunctionalLexerBase(std::string const &infilename, std::string const &outfilename);
...
inline std::ostream &PredicateFunctionalLexerBase::out()
{
    return *d_out;
}

inline void PredicateFunctionalLexerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void PredicateFunctionalLexerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline bool PredicateFunctionalLexerBase::atFinalState()
{
    return d_final.notAtBOL.rule != std::numeric_limits<size_t>::max() || 
            (d_atBOL && d_final.atBOL.rule != std::numeric_limits<size_t>::max());
}

inline void PredicateFunctionalLexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void PredicateFunctionalLexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &PredicateFunctionalLexerBase::matched() const
{
    return d_matched;
}

inline PredicateFunctionalLexerBase::StartCondition__ PredicateFunctionalLexerBase::startCondition() const
{
    return d_startCondition;
}

inline std::string const &PredicateFunctionalLexerBase::filename() const
{
    return d_filename;
}

inline void PredicateFunctionalLexerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t PredicateFunctionalLexerBase::length() const
{
    return d_matched.size();
}

inline void PredicateFunctionalLexerBase::leave(int retValue) const
{
    throw static_cast<Leave__>(retValue);
}

inline size_t PredicateFunctionalLexerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void PredicateFunctionalLexerBase::more()
{
    d_more = true;
}

inline void PredicateFunctionalLexerBase::begin(StartCondition__ startCondition)
{
    d_dfaBase__ = 
        s_dfaBase__[static_cast<int>(d_startCondition = startCondition)];
}

inline size_t PredicateFunctionalLexerBase::state__() const
{
    return d_state;
}

inline size_t PredicateFunctionalLexerBase::get__()
{
    return d_input.get();
}

inline bool PredicateFunctionalLexerBase::return__()
{
    return d_return;
}

inline void PredicateFunctionalLexerBase::noReturn__()
{
    d_return = false;
}


#endif //  PredicateFunctionalLexerBASE_H_INCLUDED
