...
void FunctionalParser::executeAction(int production)
{
    ...
    switch (production)
    {
        ...
        case 4:
        { this->predicate->addPostfixExpression(Expression::Token::ADD); }
        break;

        case 5:
        { this->predicate->addPostfixExpression(Expression::Token::SUB); }
        break;

        case 6:
        { this->predicate->addPostfixExpression(Expression::Token::MUL); }
        break;

        case 7:
        { this->predicate->addPostfixExpression(Expression::Token::MOD); }
        break;

        case 8:
        { this->predicate->addPostfixExpression(Expression::Token::POW); }
        break;

        case 9:
        { this->predicate->addPostfixExpression(Expression::Token::MIN); }
        break;

        case 10:
        { this->predicate->addPostfixExpression(Expression::Token::MAX); }
        break;

        case 11:
        { this->predicate->addPostfixExpression(Expression::Token::EQ); }
        break;

        case 12:
        { this->predicate->addPostfixExpression(Expression::Token::NEQ); }
        break;

        case 13:
        { this->predicate->addPostfixExpression(Expression::Token::GE); }
        break;

        case 14:
        { this->predicate->addPostfixExpression(Expression::Token::GT); }
        break;

        case 15:
        { this->predicate->addPostfixExpression(Expression::Token::LE); }
        break;

        case 16:
        { this->predicate->addPostfixExpression(Expression::Token::LT); }
        break;

        case 17:
        { this->predicate->addPostfixExpression(Expression::Token::NOT); }
        break;

        case 18:
        { this->predicate->addPostfixExpression(Expression::Token::AND); }
        break;

        case 19:
        { this->predicate->addPostfixExpression(Expression::Token::OR); }
        break;

        case 20:
        { this->predicate->addPostfixExpression(Expression::Token::XOR); }
        break;

        case 21:
        { this->predicate->addPostfixExpression(Expression::Token::IFF); }
        break;
        ...
        case 23:
        { this->predicate->addPostfixExpression(Expression::Token::CONST, d_scanner.matched()); }
        break;
