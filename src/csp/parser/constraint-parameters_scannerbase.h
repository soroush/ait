...
#ifndef ConstraintParametersLexerBASE_H_INCLUDED
#define ConstraintParametersLexerBASE_H_INCLUDED
...
class ConstraintParametersLexerBase
{
...
protected:
    ...
    int     const (*d_dfaBase__)[18];

    static int     const s_dfa__[][18];
    static int     const (*s_dfaBase__[])[18];
...
public:
    ConstraintParametersLexerBase(ConstraintParametersLexerBase const &other)             = delete;
    ConstraintParametersLexerBase &operator=(ConstraintParametersLexerBase const &rhs)    = delete;
...
protected:
    ConstraintParametersLexerBase(std::istream &in, std::ostream &out);
    ConstraintParametersLexerBase(std::string const &infilename, std::string const &outfilename);
...
inline std::ostream &ConstraintParametersLexerBase::out()
{
    return *d_out;
}

inline void ConstraintParametersLexerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void ConstraintParametersLexerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline bool ConstraintParametersLexerBase::atFinalState()
{
    return d_final.notAtBOL.rule != std::numeric_limits<size_t>::max() || 
            (d_atBOL && d_final.atBOL.rule != std::numeric_limits<size_t>::max());
}

inline void ConstraintParametersLexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void ConstraintParametersLexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &ConstraintParametersLexerBase::matched() const
{
    return d_matched;
}

inline ConstraintParametersLexerBase::StartCondition__ ConstraintParametersLexerBase::startCondition() const
{
    return d_startCondition;
}

inline std::string const &ConstraintParametersLexerBase::filename() const
{
    return d_filename;
}

inline void ConstraintParametersLexerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t ConstraintParametersLexerBase::length() const
{
    return d_matched.size();
}

inline void ConstraintParametersLexerBase::leave(int retValue) const
{
    throw static_cast<Leave__>(retValue);
}

inline size_t ConstraintParametersLexerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void ConstraintParametersLexerBase::more()
{
    d_more = true;
}

inline void ConstraintParametersLexerBase::begin(StartCondition__ startCondition)
{
    d_dfaBase__ = 
        s_dfaBase__[static_cast<int>(d_startCondition = startCondition)];
}

inline size_t ConstraintParametersLexerBase::state__() const
{
    return d_state;
}

inline size_t ConstraintParametersLexerBase::get__()
{
    return d_input.get();
}

inline bool ConstraintParametersLexerBase::return__()
{
    return d_return;
}

inline void ConstraintParametersLexerBase::noReturn__()
{
    d_return = false;
}


#endif //  ConstraintParametersLexerBASE_H_INCLUDED
