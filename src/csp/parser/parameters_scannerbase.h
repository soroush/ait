...
#ifndef ParametersLexerBASE_H_INCLUDED
#define ParametersLexerBASE_H_INCLUDED
...
protected:
    ...
    int     const (*d_dfaBase__)[20];

    static int     const s_dfa__[][20];
    static int     const (*s_dfaBase__[])[20];
...
public:
    ParametersLexerBase(ParametersLexerBase const &other)             = delete;
    ParametersLexerBase &operator=(ParametersLexerBase const &rhs)    = delete;
...
protected:
    ParametersLexerBase(std::istream &in, std::ostream &out);
    ParametersLexerBase(std::string const &infilename, std::string const &outfilename);
...
inline std::ostream &ParametersLexerBase::out()
{
    return *d_out;
}

inline void ParametersLexerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void ParametersLexerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline bool ParametersLexerBase::atFinalState()
{
    return d_final.notAtBOL.rule != std::numeric_limits<size_t>::max() || 
            (d_atBOL && d_final.atBOL.rule != std::numeric_limits<size_t>::max());
}

inline void ParametersLexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void ParametersLexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &ParametersLexerBase::matched() const
{
    return d_matched;
}

inline ParametersLexerBase::StartCondition__ ParametersLexerBase::startCondition() const
{
    return d_startCondition;
}

inline std::string const &ParametersLexerBase::filename() const
{
    return d_filename;
}

inline void ParametersLexerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t ParametersLexerBase::length() const
{
    return d_matched.size();
}

inline void ParametersLexerBase::leave(int retValue) const
{
    throw static_cast<Leave__>(retValue);
}

inline size_t ParametersLexerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void ParametersLexerBase::more()
{
    d_more = true;
}

inline void ParametersLexerBase::begin(StartCondition__ startCondition)
{
    d_dfaBase__ = 
        s_dfaBase__[static_cast<int>(d_startCondition = startCondition)];
}

inline size_t ParametersLexerBase::state__() const
{
    return d_state;
}

inline size_t ParametersLexerBase::get__()
{
    return d_input.get();
}

inline bool ParametersLexerBase::return__()
{
    return d_return;
}

inline void ParametersLexerBase::noReturn__()
{
    d_return = false;
}


#endif //  ParametersLexerBASE_H_INCLUDED
