...
#ifndef PROTOBUF_abt_5fprecompiled_2eproto__INCLUDED
#define PROTOBUF_abt_5fprecompiled_2eproto__INCLUDED
...
class P_EndPoint : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void protobuf_ShutdownFile_abt_5fprecompiled_2eproto();
...
inline void P_EndPoint::set_allocated_name(::std::string* name) {
  if (name_ != &::google::protobuf::internal::kEmptyString) {
    delete name_;
  }
  if (name) {
...
#endif  // PROTOBUF_abt_5fprecompiled_2eproto__INCLUDED
