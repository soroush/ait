...
#ifndef PROTOBUF_aabt_2eproto__INCLUDED
#define PROTOBUF_aabt_2eproto__INCLUDED
...
class P_Assignment : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_aabt_2eproto();
  friend void protobuf_AssignDesc_aabt_2eproto();
  friend void protobuf_ShutdownFile_aabt_2eproto();
...
class P_CVOrderData : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_assignment(::AIT::protocols::csp::aabt::P_Assignment* assignment);
...
class P_Message : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_vi(::AIT::protocols::csp::aabt::P_Assignment* vi);
  ...
  inline void set_allocated_ei(::AIT::protocols::csp::aabt::P_Explanation* ei);
  ...
  inline void set_allocated_nogood(::AIT::protocols::csp::aabt::P_NoGood* nogood);
...
inline void P_NoGood::set_allocated_lhs(::AIT::protocols::csp::aabt::P_CompoundAssignment* lhs) {
  delete lhs_;
  lhs_ = lhs;
  if (lhs) {
    set_has_lhs();
...
inline void P_NoGood::set_allocated_rhs(::AIT::protocols::csp::aabt::P_Assignment* rhs) {
  delete rhs_;
  rhs_ = rhs;
  if (rhs) {
    set_has_rhs();
...
inline void P_Explanation::set_allocated_lhs(::AIT::protocols::csp::aabt::P_CompoundAssignment* lhs) {
  delete lhs_;
  lhs_ = lhs;
  if (lhs) {
    set_has_lhs();
...
inline void P_CVOrderData::set_allocated_assignment(::AIT::protocols::csp::aabt::P_Assignment* assignment) {
  delete assignment_;
...
inline void P_Message::set_type(::AIT::protocols::csp::aabt::P_MessageType value) {
  assert(::AIT::protocols::csp::aabt::P_MessageType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
inline void P_Message::set_allocated_vi(::AIT::protocols::csp::aabt::P_Assignment* vi) {
  delete vi_;
  vi_ = vi;
  if (vi) {
    set_has_vi();
...
inline void P_Message::set_allocated_ei(::AIT::protocols::csp::aabt::P_Explanation* ei) {
  delete ei_;
  ei_ = ei;
  if (ei) {
    set_has_ei();
...
inline void P_Message::set_allocated_nogood(::AIT::protocols::csp::aabt::P_NoGood* nogood) {
  delete nogood_;
  nogood_ = nogood;
  if (nogood) {
    set_has_nogood();
...
#endif  // PROTOBUF_aabt_2eproto__INCLUDED
